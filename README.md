...
\- telecom\_customer\_churn.csv

\- telecom\_data\_dictionary.csv

\- telecom\_zipcode\_population.csv 
...
After cleaning, attached the dataset: cleaned\_dataset\_customer.xlsx (excel > cleaned dataset)
